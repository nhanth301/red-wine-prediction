    ...
    def main(self):
        try:
            ...
            if status == "True":
                ...
                train,val,test = data_transformation.train_test_splitting()
                preprocessor,train,val,test = data_transformation.preprocess(train,val,test)
                data_transformation.save2artifact(preprocessor,train,val,test)
            else:
